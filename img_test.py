...
def preprocess_image(img_path, target_size=(880, 500)):  # Adjust target size as needed
...
def predict_image(img_path, class_labels=None):
    ...
    if class_labels:
        predicted_class = class_labels[np.argmax(predictions)]  # Get class name
...
# Example usage
image_path = "michy.png"  # Replace with an actual image path
class_labels = []  # Replace with your classes
